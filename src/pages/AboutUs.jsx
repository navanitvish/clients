  ...
  return (
    <div className=" text-gray-200 p-8 max-w-6xl mx-auto rounded-lg">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400 bg-clip-text text-transparent mb-4">What We Do</h2>
        <p className="text-lg mb-4 border border-gray-700 bg-gray-800/50 p-4 rounded-lg">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400 bg-clip-text text-transparent mb-4">Our Contests</h2>
        <p className="text-lg mb-4 border border-gray-700 bg-gray-800/50 p-4 rounded-lg">We offer two exciting types of contests to suit different preferences:</p>
        
        <ol className="list-decimal pl-6 space-y-4">
          <li>
            <h3 className="text-2xl font-semibold bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400 bg-clip-text text-transparent">Simple Contests</h3>
            <ul className="list-disc pl-6 text-lg border border-gray-700 bg-gray-800/50 p-4 rounded-lg mt-2">
          ...
          <li>
            <h3 className="text-2xl font-semibold bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400 bg-clip-text text-transparent">Private Contests</h3>
            <ul className="list-disc pl-6 text-lg border border-gray-700 bg-gray-800/50 p-4 rounded-lg mt-2">
      ...
      <section className="mb-8">
        <h2 className="text-3xl font-semibold bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400 bg-clip-text text-transparent mb-4">Legal Position</h2>
        <h3 className="text-2xl font-semibold bg-gradient-to-r from-purple-500 via-pink-500 to-yellow-400 bg-clip-text text-transparent mb-4">Is Playing WonByBid Legal?</h3>
        <p className="text-lg mb-4 border border-gray-700 bg-gray-800/50 p-4 rounded-lg">
      ...
      <section className="mb-8">
        ...
        <ul className=" pl-6 text-lg space-y-4">
          ...
          <li className="border border-gray-700 bg-gray-800/50 p-4 rounded-lg"><strong>Skill-Based Gaming:</strong> Your strategy and decisions drive your success.</li>
          <li className="border border-gray-700 bg-gray-800/50 p-4 rounded-lg"><strong>Legal and Safe:</strong> Fully compliant with Indian laws, offering a secure and trustworthy platform.</li>
        </ul>
      </section>

      <section className="text-center">
        <p className="text-lg border border-gray-700 bg-gray-800/50 p-4 rounded-lg">For more information, contact us and start your journey with WonByBid today. Whether you're here for quick results or a personalized challenge, we've got you covered!</p>
      </section>
    </div>
  );
};
