    ...
    <div className="bg-gray-900 text-white p-8 max-w-6xl mx-auto rounded-lg shadow-lg">
      ...
      <section className="mb-8">
        ...
        <ul className=" pl-6 text-lg mb-4">
          ...
          <li className="border border-gray-700 bg-gray-800 p-4 rounded">Payment Information: If you participate in cash contests, we may collect billing and payment information.</li>
        </ul>
      </section>
      ...
      <section className="mb-8 space-y-6">
        ...
        <ul className=" pl-6 text-lg mb-4 space-y-6">
          ...
          <li className="border border-gray-700 bg-gray-800 p-4 rounded">Improve our platform's performance and develop new features.</li>
          <li className="border border-gray-700 bg-gray-800 p-4 rounded">Ensure the security of our platform by detecting and preventing fraudulent or unauthorized activities.</li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="space-y-6 pl-6 text-lg mb-4">
          ...
          <li className="border border-gray-700 bg-gray-800 p-4 rounded">Withdraw your consent for processing your personal data at any time.</li>
        </ul>
        <p className="text-lg mb-4 border border-gray-700 bg-gray-800 p-4 rounded">
