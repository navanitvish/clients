...
const HackingAwareness = () => {
  return (
    <div className="bg-gray-900 text-gray-300 p-8 max-w-6xl mx-auto rounded-lg">
      ...
      <section className="mb-8">
        ...
        <p className="text-lg mb-4 border border-gray-700 bg-gray-800 p-4 rounded">To ensure your safety, please follow these precautions:</p>
